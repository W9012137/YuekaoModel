...
public class MainSActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initSearchHistory() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                mEtInput.setText(mHistoryKeywords.get(i));
                mSearchHistoryLl.setVisibility(View.GONE);
            }
        });
        ...
        for (int i = 0; i < mVals.length; i++) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //加入搜索历史纪录记录
                    Toast.makeText(MainSActivity.this, str, Toast.LENGTH_LONG).show();
                }
            });
    ...
    private void initView() {
        mSaomiao = (ImageView) findViewById(R.id.saomiao);
        mIvG = (Button) findViewById(R.id.iv_g);
        ...
        mSearchHistoryLv = (ListView) findViewById(R.id.search_history_lv);
    ...
    public void cleanHistory() {
        ...
        mArrAdapter.notifyDataSetChanged();
        mSearchHistoryLl.setVisibility(View.GONE);
        Toast.makeText(MainSActivity.this, "清楚搜索历史成功", Toast.LENGTH_LONG).show();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            default:
                break;
            case R.id.iv_g:
                String keywords = mEtInput.getText().toString();
                if (!TextUtils.isEmpty(keywords)) {
                    Toast.makeText(MainSActivity.this, keywords + "save成功", Toast.LENGTH_LONG).show();
                    save();
                } else {
                    Toast.makeText(MainSActivity.this, "请输入搜索内容", Toast.LENGTH_LONG).show();
                }
                break;
